...
struct Settings {
    ...
    double                  kLambda = 5.0;                  // The rate parameter for the transition/transversion exponential prior
    double                  kWeight = 1.0;                  // Weight associated with updating the transition/transversion rate parameter
    double                  omegaLambda = 5.0;              // The rate parameter for the non-synonymous/synonymous exponential prior
    ...
    double                  rLambda = 5.0;                  // The rate parameter for the evolutionary regime swapping exponential prior
    ...
    double                  treeLengthSD = 10.0;             // The SD parameter associated with the tree length prior
    ...
    id_t                    threads = 1;                    // How many threads to use in the analysis
