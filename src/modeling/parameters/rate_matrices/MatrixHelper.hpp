...
namespace MatrixHelper {
     ...
     */
    static constexpr std::array<int, 3> possibleMerge3 = {0, 1, 2};
    static constexpr std::array<int, 3> possibleSplit3 = {1, 2, 0};

    /**
     * @brief The number of possible split merge moves that can occur at each omega count when the cap is 5
     */
    static constexpr std::array<int, 5> possibleMerge5 = {0, 1, 2, 3, 4};
    static constexpr std::array<int, 5> possibleSplit5 = {1, 2, 3, 4, 0};
